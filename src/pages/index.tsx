...
import { BsCircleFill, BsWhatsapp, BsTelephone } from "react-icons/bs";
    ...
    <div className="flex flex-col">
      ...
      >
        ...
        <p className="text-text mt-4 mb-12 w-2/4 text-center leading-6">
          E agora? Sinta-se confortável para entrar em contato comigo caso
          esteja buscando por um desenvolvedor ou simplesmente queira se
          conectar.
        </p>
