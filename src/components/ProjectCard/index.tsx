...
export const ProjectCard: FC<Props> = ({ project }) => {
  return (
    <div className="flex">
      <div className="flex items-center p-12 bg-label rounded-tl-xl rounded-bl-xl">
        <Image
          src={project.image}
          alt=""
          width={480}
      ...
      <div className="flex flex-col max-w-[36rem] gap-6 p-12 bg-sub-background rounded-tr-xl rounded-br-xl">
